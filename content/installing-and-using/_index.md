...
Использование файла скрипта это простейший путь <!-- способ --> экспериментировать с F#; просто вбивайте любой код в окно сценария и запускайте его, чтобы увидеть результаты <!-- дословно: "вывод", "то, что этот код выведет" --> в интерактивном окне ниже.
...
После этого вводить код в окне скрипта и используйте контекстное меню, чтобы отправить код в интерактивное окно (как показано ниже).
...
Вы можете поэкспериментировать с этим скриптом или написать несколько своих. <!-- Дословно: "Пока вы играете с кодом на этом сайте, вы можете в то же время захотеть поэкспериментировать, создавая свои сценарии." -->