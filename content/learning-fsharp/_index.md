...
F# позволяет использовать нефункциональные подходы, и возникает соблазн сохранить уже знакомые привычки.
...
Так что, пожалуйста, прочтите и перечитайте серию ["думать функционально"](/series/thinking-functionally.html) и ["понимание F# типов"](/series/understanding-fsharp-types.html), поиграйтесь с примерами, и освойтесь с идеями, прежде чем приступать к серьёзному кодированию. 

>If you don't understand how functions and types work, then you will have a hard time being productive.

Если вы не понимаете, как работают функции и типы, тогда вам будет тяжело быть продуктивным.
...
Написание сложных фунций без "костылей" в виде изменяемого состояния действительно продвинет вас в понимании функциональной парадигмы.
...
<!--Есть вариант использовать "ставить точки", но мне кажется он звучит как-то не так -->
